...
class TNTBox extends Rectangle {

  int _id;
  bool _visible;
  static List<TNTBox> _created = new List<TNTBox>();

  //Creates a new object of the class TNTBox.
  TNTBox(Position positionBottomLeft, Position positionBottomRight, Position positionTopLeft, Position positionTopRight, Position currentPosition, int radius, MotionController motionController)
      : super(positionBottomLeft, positionBottomRight, positionTopLeft, positionTopRight, false, "TNTBox", currentPosition, radius, motionController) {
    this._id = _created.length;
    this._visible = true;
    _created.add(this);
  }

  //Factory method to return an object of the class TNTBox.
  factory TNTBox.fromId(int id, Position positionBottomLeft, Position positionBottomRight, Position positionTopLeft, Position positionTopRight, Position currentPosition, int radius, MotionController motionController){
    var existing;
    ...
    if(existing != null) {
      ...
      existing = new TNTBox(positionBottomLeft, positionBottomRight, positionTopLeft, positionTopRight, currentPosition, radius, motionController);
    }
    return existing;
  }
